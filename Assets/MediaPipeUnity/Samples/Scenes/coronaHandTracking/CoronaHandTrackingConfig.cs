...
{
  public class CoronaHandTrackingConfig : ModalContents
  {
    ...
    private CoronaHandTrackingSolution _solution;
    ...
    private void Start()
    {
      _solution = GameObject.Find("Solution").GetComponent<CoronaHandTrackingSolution>();
      InitializeContents();
    }
    ...
    {
      _solution.modelComplexity = (CoronaHandTrackingGraph.ModelComplexity)_modelComplexityInput.value;
      _isChanged = true;
    }
    ...
    private void InitializeModelComplexity()
    {
      ...
      var options = new List<string>(Enum.GetNames(typeof(CoronaHandTrackingGraph.ModelComplexity)));
