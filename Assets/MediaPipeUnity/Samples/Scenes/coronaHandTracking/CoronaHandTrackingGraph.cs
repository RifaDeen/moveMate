...
{
  public readonly struct coronaHandTrackingResult
  {
    ...
    public coronaHandTrackingResult(List<Detection> palmDetections, List<NormalizedRect> handRectsFromPalmDetections,
  ...
  public class CoronaHandTrackingGraph : GraphRunner
  {
    ...
    public async Task<coronaHandTrackingResult> WaitNext()
    {
      ...
      return new coronaHandTrackingResult(palmDetections, handRectsFromPalmDetections, handLandmarks, handWorldLandmarks, handRectsFromLandmarks, handedness);
    }
