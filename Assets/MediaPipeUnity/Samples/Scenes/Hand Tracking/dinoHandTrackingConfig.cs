...
{
  public class dinoHandTrackingConfig : ModalContents
  {
    ...
    private dinoHandTrackingSolution _solution;
    ...
    private void Start()
    {
      _solution = GameObject.Find("Solution").GetComponent<dinoHandTrackingSolution>();
      InitializeContents();
    }
    ...
    {
      _solution.modelComplexity = (dinoHandTrackingGraph.ModelComplexity)_modelComplexityInput.value;
      _isChanged = true;
    }
    ...
    private void InitializeModelComplexity()
    {
      ...
      var options = new List<string>(Enum.GetNames(typeof(dinoHandTrackingGraph.ModelComplexity)));
